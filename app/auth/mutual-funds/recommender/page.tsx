            ...
            <Card className="w-full max-w-2xl mx-auto bg-neutral-200/50 dark:bg-neutral-800 p-4 rounded-md shadow-xl ">
                ...
                <CardContent>
                    ...
                    <Form {...recommendationForm}>
                        <form onSubmit={recommendationForm.handleSubmit(onSubmit)} className="space-y-4">
                            <FormField
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <FormControl>
                                            <Select onValueChange={field.onChange} defaultValue={field.value} {...field} disabled={isPending}>
                                                <SelectTrigger >
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <FormDescription>
                                            Choose your risk appetite from 1 (Very Low) to 6 (Extreme).
                                        </FormDescription>
                                        <FormMessage />
                                    </FormItem>
                                )}
